...
from app.utils.save_to_disk import rename_project_category, del_project_category
import os
...
class CategoryResource(Resource):
    ...
    def put(self, category_id):
        ...
        try:
            ...
            try:
                ...
                parser.add_argument('category_full_path', type=str, required=True, help='目录全路径')
            ...
            if is_success:
                rename_project_category(user.username, project.name, args['category_full_path'], os.path.join(args['category_full_path'].rsplit('/', 1)[0], args['name']))
    ...
    def delete(self, category_id):
        ...
        try:
            ...
            if is_success:
                del_project_category(current_user.username, current_project.name, args['category_full_path'])
