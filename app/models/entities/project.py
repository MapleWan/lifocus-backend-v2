...
class Project(db.Model):
    ...
    description = db.Column(db.String(255), nullable=False, comment='项目描述')
    folder = db.Column(db.String(255), nullable=False, comment='项目文件存储文件夹')
    status = db.Column(db.String(64), nullable=False, default='active', comment='项目状态')
    is_deleted = db.Column(db.Boolean, nullable=True, default=False, comment='是否删除项目')
